<div class="group w-full bg-white rounded-xl shadow-sm border border-gray-100 p-3 transition-all duration-300 hover:shadow-md flex flex-col h-full ">
  ...
  <div class="relative rounded-xl overflow-hidden aspect-square bg-[#2482ee] mb-3 group cursor-pointer">
    ...
    <div class="absolute bottom-4 right-4 translate-x-4 opacity-0 transition-all duration-300 ease-out group-hover:translate-x-0 group-hover:opacity-100">
      <button class="heart-btn relative flex items-center justify-center h-10 w-10 cursor-pointer rounded border border-gray-200/60 bg-white/90 text-gray-700 shadow-sm backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:border-gray-200 hover:bg-gray-200">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-4 w-4 transition-transform duration-200 active:scale-90">
