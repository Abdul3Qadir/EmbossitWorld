            ...
            <div class="lg:col-span-8 flex flex-col justify-between h-full space-y-8 lg:pl-6">
                ...
                <div class="space-y-6 pt-8 border-t border-slate-100 mt-auto">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                        <div class="sm:col-span-3 flex items-center border border-slate-200 rounded-2xl bg-slate-50 p-1.5 min-h-[58px] justify-between shadow-inner">
                            <button onclick="decrementQty()" class="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-white text-slate-700 transition active:scale-95 font-bold text-xl">-</button>
                            <input id="quantity" type="number" value="1" min="1" class="w-10 text-center border-none bg-transparent focus:outline-none focus:ring-0 font-black text-slate-900 text-base">
                            <button onclick="incrementQty()" class="w-10 h-10 flex items-center justify-center rounded-xl hover:bg-white text-slate-700 transition active:scale-95 font-bold text-xl">+</button>
                        </div>
